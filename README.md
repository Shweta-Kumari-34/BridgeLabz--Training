...
- Introduction of Data Structure its key features in java
- Types of Data Structures in Java
- Studied about Single Linked List, Double Linked List, Circular  Linked List
- Made repository named dsa-question-Practice for DSA.
...
- Studied the concepts of Stacks, Queue, Hashap & Hash function
- Studied about its key features, use cases, algorithms and operations
- Studied the time Complexity og these data structures 
...
**(Date: 17-Jan-2026)**
- Solved four scenario based questions based on sorting algorithms
- Sort Artists by Registration Time,  Vehicle Maintenance Scheduler
- Sorting Flavors by Popularity, Auto-Sort Borrowed Books
- Problem based on sorting algorithms (Bubble Sort, Insertion Sort, Merge Sort)
- Committed and pushed solutions to the repository.
...
---
### Week 6 : Scenario-Based Question And DSA Concepts
---

### Day 1-DSA Scenario Based Questions 
**(Date: 19-Jan-2026)**
- Solved three scenario based questions based on sorting algorithms
- EduResults – Rank Sheet Generator, FlashDealz – Product Sorting by Discount
- FitnessTracker – Daily Step Count Ranking 
- Problem based on sorting algorithms (Bubble Sort, Quick Sort, Merge Sort)
- Committed and pushed solutions to the repository.
